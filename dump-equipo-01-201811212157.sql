...
--
-- Host: localhost    Database: equipo-01
-- ------------------------------------------------------
...
INSERT INTO `actuador` VALUES ('prender',1,'/dispositivo/luz living',1),('apagar',2,'/dispositivo/tv',2),('prender',3,'/dispositivo/tv',3),('pasar_a_modo_ahorro',4,'/dispositivo/luz living',4);
...
INSERT INTO `administrador` VALUES ('2018-11-22 00:56:23',1);
...
INSERT INTO `cliente_residencial` VALUES (_binary '','2018-03-22 00:56:23',45,2,1,NULL,NULL),(_binary '','2018-03-22 00:56:24',9999,5,8,NULL,NULL);
...
INSERT INTO `coordenada` VALUES (1,3.3,4.4,2),(2,-34.1857989,-58.2993033,3),(3,-34.1857989,-58.2993033,4),(4,-34.1857985,-58.2993031,5),(5,-34.1857985,-58.2993031,6),(6,-34.1852919,-58.3002024,7),(7,-34.1864335,-58.3001311,7),(8,-34.1853531,-58.2990609,7),(9,-34.1863644,-58.2989768,7),(10,-34.1862543,-58.2979865,7),(11,-58.2989654,-34.9865444,7);
...
INSERT INTO `criterio` VALUES ('igualdad',1,30,0,0,1,1),('mayor',2,30,0,0,2,2),('menor',3,30,0,0,3,3),('igualdad',4,25,0,0,4,4);
...
CREATE TABLE `dispositivo` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_44ervupk1edjdm4yj3anklvbt` (`nombre`),
...
INSERT INTO `dispositivo` VALUES ('inteligente',1,'tv','Apagable',6,2),('inteligente',2,'luz living','Apagable',21,2),('standard',3,'stan','Apagable',3,2);
...
INSERT INTO `estadoDispositivo` VALUES ('apagado',1,NULL,'2018-11-22 00:56:23',NULL),('encendido',2,'2018-09-22 00:56:23','2018-08-22 00:56:23',1),('encendido',3,'2018-10-30 00:56:23','2018-10-29 00:56:23',1),('apagado',4,'2018-11-20 00:56:23','2018-10-31 00:56:23',1),('encendido',5,'2018-11-21 14:56:23','2018-11-21 00:56:23',1),('apagado',6,NULL,'2018-11-22 00:56:24',NULL),('encendido',7,'2018-09-22 00:56:24','2018-08-22 00:56:24',2),('encendido',8,'2018-10-30 00:56:24','2018-10-29 00:56:24',2);
...
INSERT INTO `historialDeEstados` VALUES (1,1),(2,2);
...
INSERT INTO `inteligente` VALUES (_binary '',15,15,1,1,1),(_binary '',30,15,2,6,2);
...
INSERT INTO `medicion` VALUES (2,45),(2,95),(2,25),(2,15),(3,325),(3,2315),(3,3125),(3,125),(4,24),(4,225),(4,23),(5,34),(5,1234),(5,3325),(5,13);
...
INSERT INTO `parametro_sistema` VALUES (1,'cantidad mediciones sensor',20,''),(2,'intervalo optimizador',10,''),(3,'tiempo optimizador',1000,''),(4,'retardo reporte',10,''),(5,'tiempo reporte',1000,''),(6,'retardo tabla',10,''),(7,'tiempo tabla',1000,''),(8,'ip broker',0,'localhost');
/*!40000 ALTER TABLE `parametro_sistema` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `poligono_mapa_calor`
--

DROP TABLE IF EXISTS `poligono_mapa_calor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `poligono_mapa_calor` (
  `consumo_instantaneo` double DEFAULT NULL,
  `opacidad` double DEFAULT NULL,
  `id` int(11) NOT NULL,
  `puntoInterior_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_ih8ho0fmq3sdenhrv4qi7pwx0` (`puntoInterior_id`),
  CONSTRAINT `FK_19i1ehwbg6dqdu9hd5ndqbfau` FOREIGN KEY (`id`) REFERENCES `ubicable` (`id`),
  CONSTRAINT `FK_ih8ho0fmq3sdenhrv4qi7pwx0` FOREIGN KEY (`puntoInterior_id`) REFERENCES `coordenada` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `poligono_mapa_calor`
--

LOCK TABLES `poligono_mapa_calor` WRITE;
/*!40000 ALTER TABLE `poligono_mapa_calor` DISABLE KEYS */;
/*!40000 ALTER TABLE `poligono_mapa_calor` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `regla` VALUES (1,'prender luz',2),(2,'apagar tv',1),(3,'prender tv',1),(4,'pasar la lampara A Modo De Ahorro Energia',2);
...
INSERT INTO `sensor` VALUES (1,NULL),(2,NULL),(3,NULL),(4,NULL),(5,NULL);
...
INSERT INTO `sensor_regla` VALUES (1,1),(2,2),(3,3),(4,4),(5,4);
...
INSERT INTO `standard` VALUES (46,_binary '\0',15,3);
...
INSERT INTO `transformador` VALUES ('transf572G',3,NULL),('transf002B',4,NULL),('transf10A',6,NULL);
...
INSERT INTO `ubicable` VALUES ('administrador',1),('clienteResidencial',2),('transformador',3),('transformador',4),('clienteResidencial',5),('transformador',6),('zona_geografica',7);
...
INSERT INTO `usuario` VALUES ('admin','admin','62acb7dcdc097eb50faf1aaa74c5acd975266f708ffba2f74fb1c22313abe137',NULL,'admin',0,_binary 't\È\– ë∞\ﬂ/gÅ¿xÊ≤û±',0,NULL,1),('kodar','odar','d7a12cf63a185d2b5b443d392acf67a3a4be82c83d1dd1f3838673c2885e6b6f','cucha cucha 2137','kevin',34325,_binary 'Xú¥Æö‹õ6\"éëÆOA',45883110,'dni',2),('cosFul','Fulanito','60aabbcc5d8d23dd5d30b378cd14c5291e49578f237dbcad200f92766e52d382','Algun lado 123','Cosme',987654321,_binary 'KŒàˇ.¶πûm-ˇΩ\œ',123456789,'dni',5);
...
INSERT INTO `zona_geografica` VALUES (7,NULL);
/*!40000 ALTER TABLE `zona_geografica` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'equipo-01'
--
...
-- Dump completed on 2018-11-21 21:57:35
